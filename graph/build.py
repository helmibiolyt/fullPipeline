...
class Build:
    def __init__(self, outdir: pathlib.Path, slice_names: set[str] | None,
        ...
        # Disease names with separators removed, so "Sars-CoV2" can reach
        # "SARS-CoV 2". Empty string means two diseases shared the key and it
        # is poisoned - see _index_squashed.
        self.mesh_squashed: dict[str, str] = {}
